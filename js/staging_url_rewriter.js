    ...
    attach: function (context, settings) {
        ...
        function replace_with_production_url(production_base_url, development_base_url, src) {
            ...
            if (replace_with_production_srcs.indexOf(src) === -1) {
                ...
                if (settings.staging_url_rewriter.is_debug) {
        ...
        jQuery("img", context).error(function (errorData) {
            var new_image_src = replace_with_production_url(settings.staging_url_rewriter.production_base_url,
                settings.basePath, jQuery(this).attr('src'));
